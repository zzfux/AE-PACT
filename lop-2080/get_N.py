    ...
    for ly, df in layer_resdf_dict.items():
        ...
        for ti  in all_time:
            if 1/ti >= best_flop * percent:
                ...
                break
            i += 1  
        res_dict[ly] = (i, best_time, threshold_time, len(all_time))
       

    for ly, tup in sorted(res_dict.items()) :
        print("{}, :=best {},  {}, perc at, {}, candid time ,{}, total config {}".format(ly, tup[1], percent, tup[0], tup[2], tup[3]) )
